...
### 6.1. Google Cloud API Key (for Weather/Pollen APIs)
...
### 12.1. Interactive Web Interface
...
### 12.2. Automated Execution via Cloud Scheduler
...
## 16. Destroying the Infrastructure
